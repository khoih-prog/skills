...
(async function () {
  ...
  const searchTerms = [
    ...
    "a", "e", "i", "o", "u",
    "el", "la", "de", "que", "per", "com", "en", "es", "un", "una",
    "the", "is", "to", "and", "for", "how", "what", "can", "my", "new",
    "AI", "code", "python", "help", "project", "plan", "mail", "work",
    "home", "casa", "buy", "water", "make", "create", "fix", "error",
    "list", "write", "find", "get", "set", "add", "use", "run",
    "file", "data", "test", "build", "open", "send", "read", "show",
    "app", "web", "api", "key", "log", "config", "install", "update",
  ];
